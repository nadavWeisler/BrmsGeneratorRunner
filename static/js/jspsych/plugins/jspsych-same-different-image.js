...
jsPsych.plugins['same-different-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<img class="jspsych-same-different-stimulus" static="'+trial.stimuli[0]+'"></img>';
    ...
    function showSecondStim() {
      ...
      var html = '<img class="jspsych-same-different-stimulus" static="'+trial.stimuli[1]+'"></img>';
      //show prompt
